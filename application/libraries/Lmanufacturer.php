...
class Lmanufacturer {
    ...
    public function manufacturer_edit_data($manufacturer_id) {
        ...
        $data = array(
            ...
            'country_list'  => $CI->Country_model->country(),
            'is_pbf_yes_selected' => ((isset($manufacturer_detail[0]['is_pbf']) && $manufacturer_detail[0]['is_pbf'] == 1) ? 'selected' : ''),
            'is_pbf_no_selected'  => ((isset($manufacturer_detail[0]['is_pbf']) && $manufacturer_detail[0]['is_pbf'] == 1) ? '' : 'selected'),
