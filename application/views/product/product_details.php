		    ...
		    <div class="col-sm-12">
		        <div class="panel panel-bd lobidrag">
		            ...
		            <div class="panel-body">
						...
						<table class="table">
							<tr>
								<th><?php echo display('total_purchase') ?> = <span>{total_purchase}</span></th>
								<th><?php echo display('total_sales') ?> = <span> {total_sales}</span></th>
								<th><?php echo display('stock') ?> = <span> {stock}</span></th>
							</tr>
						</table>
		            </div>
		        </div>
