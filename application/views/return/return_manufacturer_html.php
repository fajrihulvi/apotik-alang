	            ...
	            <div class="row print_header"> 
                             ...
                             <span class="label label-success-outline m-r-15"><?php echo display('billing_to') ?></span>
	                                  ...
	                                  <address class="customer_name_p">  
	                                    <span><?php echo display('manufacturer')?></span> : <strong class="c_name">{manufacturer_name} </strong><br>
	                                    <?php if ($address) { ?>
	                        ...
	                        <div class="row">
		                            ...
		                            <div class="col-xs-4">
				                        ...
				                        <table class="table">
			                                ...
			                                ?>
				                            	<tr>
				                            		<th><?php echo display('deduction') ?> : </th>
			                                ...
			                                ?>
				                            	<tr>
				                            		...
				                            		<td class="grand_total text-center"><?php echo (($position==0)?"$currency {total_amount}":"{total_amount} $currency") ?></td>
				                            	</tr>
