...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('return_form');?></h1>
            <small><?php echo display('return_form');?></small>
        </div>
    </section>
        ...
        if($this->permission1->method('return','create')->access()){ ?>
         <div class="row">
                        ...
                        <?php echo form_open('Cretrun_m/invoice_return_form',array('class' => 'form-inline'))?>
                         <div class="col-sm-12">
                           ...
                           <div class="col-sm-1"></div>
                            <div class="col-sm-2"> <button type="submit" class="btn btn-success"><?php echo display('search') ?></button></div>
                            </div>
            ...
            <div class="col-sm-6">
                <div class="panel panel-default">
                      <div class="panel-body">
                        <?php echo form_open('Cretrun_m/manufacturer_return_form',array('class' => 'form-inline'))?>
                            <div class="col-sm-12">
                              <center> <h4><?php echo display('manufacturer_return');?></h4></center>
                            </div>
                            <label for="purchase_id" class="col-sm-4"><?php echo display('purchase_id') ?>:</label>

                              <div class="form-group">
                                 <input type="text"   name="purchase_id" class="purchase_id form-control" placeholder='<?php echo display('purchase_id') ?>' id="purchase_id" />
