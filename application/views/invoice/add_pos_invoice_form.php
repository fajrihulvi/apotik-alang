...
<script src="<?php echo base_url() ?>my-assets/js/admin_js/posbarcode.js" type="text/javascript"></script>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <option value="<?php echo html_escape($ptype['id'])?>" data-bank="<?php echo (payment_needs_bank($ptype['payment_type_name']) ? 1 : 0)?>"><?php echo html_escape($ptype['payment_type_name'])?></option>
                                <?php } ?>
                                        </select>
                        ...
                        <div class="table-responsive">
                             <table class="table table-bordered table-hover" id="normalinvoice">
                                    <thead>
                                    <tr>
                                        <th class="text-center productSelection"
                         ...
                         <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <a class="btn btn-info" type="button" onClick="addInputField('addinvoiceItem');" tabindex="12" id="add_invoice_item"><i class="fa fa-plus"></i>
                                            </a>
