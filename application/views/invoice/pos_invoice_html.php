    ...
    <section class="content">
        ...
        <body>
                    ...
                    <div>
                        <div class="panel-body" id="printableArea">
                            <?php if (!empty($Web_settings[0]['receipt_header'])) { ?>
                                <div class="receipt-header" style="text-align:center;"><?php echo $Web_settings[0]['receipt_header']; ?></div>
                            <?php } ?>
                ...
                <tr>
                    <td>
                        <table border="0" width="100%" >
                            <tr>
                                {company_info}
                                <td align="center" class="print_header"></td>
                                {/company_info}
                            </tr>
                            <tr>
            ...
            <?php if (!empty($Web_settings[0]['receipt_footer'])) { ?>
                <div class="receipt-footer" style="text-align:center;"><?php echo $Web_settings[0]['receipt_footer']; ?></div>
            <?php } ?>
        </div>
