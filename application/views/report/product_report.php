		        ...
		        <div class="panel panel-default">
		            <div class="panel-body"> 
		                ...
		                <?php date_default_timezone_set("Asia/Dhaka"); $today = date('Y-m-d'); ?>
		                    ...
		                    <a  class="btn btn-success" id="product_excel_link" href="<?php echo base_url('Admin_dashboard/product_sales_report_excel')?>?from_date=<?php echo urlencode($start) ?>&amp;to_date=<?php echo urlencode($end) ?>"><i class="fa fa-file-excel-o"></i> Download Excel</a>
		               ...
		               (function () {
		                   var link = document.getElementById('product_excel_link');
		                   if (!link) { return; }
		                   var base = '<?php echo base_url('Admin_dashboard/product_sales_report_excel')?>';
