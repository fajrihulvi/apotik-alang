		        ...
		        <div class="panel panel-default">
		            <div class="panel-body"> 
		                ...
		                <?php date_default_timezone_set("Asia/Dhaka"); $today = date('Y-m-d'); ?>
		                    ...
		                    <a  class="btn btn-success" id="purchase_excel_link" href="<?php echo base_url('Admin_dashboard/todays_purchase_report_excel')?>?from_date={start_date}&amp;to_date={end_date}"><i class="fa fa-file-excel-o"></i> Download Excel</a>
		               <?php echo form_close()?>
		               ...
		               (function () {
		                   var link = document.getElementById('purchase_excel_link');
		                   if (!link) { return; }
		                   var base = '<?php echo base_url('Admin_dashboard/todays_purchase_report_excel')?>';
		            	...
		            	<div id="purchase_div">
			                ...
			                <div class="table-responsive">
			                    <table class="table table-bordered table-striped table-hover">
									...
									<tfoot>
										<tr>
											<td colspan="3" align="right" class="text-right">&nbsp; <b><?php echo display('total_purchase') ?> </b></td>
