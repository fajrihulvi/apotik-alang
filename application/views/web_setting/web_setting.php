                ...
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('Cweb_setting/update_setting', array('class' => 'form-vertical','id' => 'insert_customer'))?>
                    <div class="panel-body">
                        ...
                        echo "selected";
                    } ?>><?php echo html_escape($clist->currency_name).' '.html_escape($clist->icon);?></option>
                                    <?php }?>
                                   </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="expiry_alert_months" class="col-sm-3 col-form-label"><?php echo display('expiry_alert_months') ?></label>
                            <div class="col-sm-6">
                                <input class="form-control" name="expiry_alert_months" id="expiry_alert_months" type="number" min="1" placeholder="8" value="<?php echo html_escape(isset($expiry_alert_months) ? $expiry_alert_months : 8); ?>">
                            </div>
                        </div>
