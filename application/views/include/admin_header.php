<?php
    ...
    $near_expiry  = $CI->Reports->near_expiry_count();
?>
<!-- Admin header end -->
    ...
    <nav class="navbar navbar-static-top text-center">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                   ...
                   <li class="dropdown notifications-menu">
                    <a href="<?php echo base_url('Creport/near_expiry')?>" title="<?php echo display('near_expiry')?>">
                        <i class="fa fa-clock-o"></i>
                        <span class="label label-warning"><?php echo html_escape($near_expiry)?></span>
                    </a>
                </li>
                <li class="dropdown notifications-menu">
...
<aside class="main-sidebar">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php
             if($this->permission1->module('new_invoice')->access() || $this->permission1->module('manage_invoice')->access() || $this->permission1->module('pos_invoice')->access()|| $this->permission1->module('gui_pos')->access() || $this->permission1->module('add_purchase')->access() || $this->permission1->module('manage_purchase')->access() || $this->permission1->module('stock_report')->access() || $this->permission1->module('stock_report_batch_wise')->access() || $this->permission1->module('return')->access() || $this->permission1->module('stock_return_list')->access() || $this->permission1->module('manufacturer_return_list')->access() || $this->permission1->module('wastage_return_list')->access()) { ?>
                <li class="treeview <?php if ($this->uri->segment('1') == ("Cinvoice") || $this->uri->segment('1') == ("Cpurchase") || $this->uri->segment('1') == ("Creport") || $this->uri->segment('1') == ("Cretrun_m")) { echo "active";}else{ echo " ";}?>">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                            ...
                            <li class="treeview <?php if ($this->uri->segment('1') == ("Cpurchase")) { echo "active";}else{ echo " ";}?>">
                                ...
                                <ul class="treeview-menu">
                                    <?php if($this->permission1->method('add_purchase','create')->access()){ ?>
                                        <li class="treeview <?php if ($this->uri->segment('1') == ("Cpurchase") && $this->uri->segment('2') == ("")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cpurchase')?>"><?php echo display('add_purchase') ?></a></li>
                                    <?php } ?>
                                    <?php if($this->permission1->method('manage_purchase','read')->access() || $this->permission1->method('manage_purchase','update')->access() || $this->permission1->method('manage_purchase','delete')->access()){ ?>
                                        <li class="treeview <?php if ($this->uri->segment('2') == ("manage_purchase")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cpurchase/manage_purchase')?>"><?php echo display('manage_purchase') ?></a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                        <?php } ?>
                            ...
                            <li class="treeview <?php if ($this->uri->segment('1') == ("Creport")) { echo "active";}else{ echo " ";}?>">
                                ...
                                <ul class="treeview-menu">
                                    <?php if($this->permission1->method('stock_report','read')->access()){ ?>
                                        <li class="treeview <?php if ($this->uri->segment('1') == ("Creport") && $this->uri->segment('2') == ("")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Creport')?>"><?php echo display('stock_report') ?></a></li>
                                    <?php } ?>
                        ...
                        <!-- Pengembalian (sub-dropdown, dipindahkan ke dalam Transaksi) -->
                        <?php
                        if($this->permission1->module('return')->access() || $this->permission1->module('stock_return_list')->access() || $this->permission1->module('manufacturer_return_list')->access() || $this->permission1->module('wastage_return_list')->access()){ ?>
                            <li class="treeview <?php if ($this->uri->segment('1') == ("Cretrun_m")) { echo "active";}else{ echo " ";}?>">
                                ...
                                <ul class="treeview-menu">
                                    <?php if($this->permission1->method('return','create')->access()){ ?>
                                        <li class="treeview <?php if ($this->uri->segment('1') == ("Cretrun_m") && $this->uri->segment('2') == ("")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cretrun_m')?>"><?php echo display('return');?></a></li>
                                    <?php } ?>
                                    <?php if($this->permission1->method('stock_return_list','read')->access()){ ?>
                                        <li class="treeview <?php if ($this->uri->segment('2') == ("return_list")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cretrun_m/return_list')?>"><?php echo display('stock_return_list') ?></a></li>
                                    <?php } ?>
                                    <?php if($this->permission1->method('manufacturer_return_list','read')->access()){ ?>
                                        <li class="treeview <?php if ($this->uri->segment('2') == ("manufacturer_return_list")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cretrun_m/manufacturer_return_list')?>"><?php echo display('manufacturer_return_list') ?></a></li>
                                    <?php } ?>
                                    <?php if($this->permission1->method('wastage_return_list','read')->access()){ ?>
                                        <li class="treeview <?php if ($this->uri->segment('2') == ("wastage_return_list")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cretrun_m/wastage_return_list')?>"><?php echo display('wastage_return_list') ?></a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                        <?php } ?>
            ...
            <!-- Grup induk selalu tampil untuk SEMUA role; tiap submenu di dalamnya tetap cek RBAC -->
            <li class="treeview <?php if ($this->uri->segment('1') == ("Cpayment_type") || $this->uri->segment('1') == ("Ccustomer") || $this->uri->segment('1') == ("Csupplier") || $this->uri->segment('1') == ("Cmanufacturer") || $this->uri->segment('1') == ("Cproduct") || $this->uri->segment('1') == ("Ccategory") || $this->uri->segment('1') == ("Creceipt_setting")) { echo "active";}else{ echo " ";}?>">
                <a href="#">
                    <i class="fa fa-database"></i><span><?php echo display('master_data') ?></span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    ...
                    <?php
                    if($this->permission1->module('add_payment_type')->access() || $this->permission1->module('payment_type_list')->access()){ ?>
                    <li class="treeview <?php if ($this->uri->segment('1') == ("Cpayment_type")) { echo "active";}else{ echo " ";}?>">
                        <a href="#">
                            <i class="fa fa-money"></i> <span><?php echo display('payment_type') ?></span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <?php if($this->permission1->method('add_payment_type','create')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('1') == ("Cpayment_type") && $this->uri->segment('2') == ("payment_type_form")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cpayment_type/payment_type_form') ?>"><?php echo display('add_payment_type') ?></a></li>
                            <?php } ?>
                            <?php if($this->permission1->method('payment_type_list','read')->access() || $this->permission1->method('payment_type_list','update')->access() || $this->permission1->method('payment_type_list','delete')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('2') == ("payment_type_list")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cpayment_type/payment_type_list') ?>"><?php echo display('payment_type_list') ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                    <?php } ?>
                    ...
                    <li class="treeview <?php if ($this->uri->segment('1') == ("Ccustomer")) { echo "active";}else{ echo " ";}?>">
                        ...
                        <ul class="treeview-menu">
                            <?php if($this->permission1->method('add_customer','create')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('1') == ("Ccustomer") && $this->uri->segment('2') == ("")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Ccustomer') ?>"><?php echo display('add_customer') ?></a></li>
                            <?php } ?>
                            <?php if($this->permission1->method('manage_customer','read')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('2') == ("manage_customer")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Ccustomer/manage_customer') ?>"><?php echo display('manage_customer') ?></a></li>
                            <?php } ?>
                            <?php if($this->permission1->method('customer_ledger','read')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('2') == ("customer_ledger_report")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Ccustomer/customer_ledger_report') ?>"><?php echo display('customer_ledger') ?></a></li>
                            <?php } ?>
                            <?php if($this->permission1->method('credit_customer','read')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('2') == ("credit_customer")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Ccustomer/credit_customer') ?>"><?php echo display('credit_customer') ?></a></li>
                            <?php } ?>
                            <?php if($this->permission1->method('paid_customer','read')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('2') == ("paid_customer")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Ccustomer/paid_customer') ?>"><?php echo display('paid_customer') ?></a></li>
                            <?php } ?>
                            <?php if($this->permission1->method('customer_advance','create')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('2') == ("customer_advance")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Ccustomer/customer_advance') ?>"><?php echo display('customer_advance') ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                    <?php } ?>
                    ...
                    <li class="treeview <?php if ($this->uri->segment('1') == ("Csupplier")) { echo "active";}else{ echo " ";}?>">
                        ...
                        <ul class="treeview-menu">
                            <?php if($this->permission1->method('add_supplier','create')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('1') == ("Csupplier") && $this->uri->segment('2') == ("")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Csupplier') ?>"><?php echo display('add_supplier') ?></a></li>
                            <?php } ?>
                            <?php if($this->permission1->method('manage_supplier','read')->access() || $this->permission1->method('manage_supplier','update')->access() || $this->permission1->method('manage_supplier','delete')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('2') == ("manage_supplier")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Csupplier/manage_supplier') ?>"><?php echo display('manage_supplier') ?></a></li>
                            <?php } ?>
                            <?php if($this->permission1->method('supplier_ledger','read')->access() || $this->permission1->method('supplier_ledger','update')->access() || $this->permission1->method('supplier_ledger','delete')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('2') == ("supplier_ledger_report")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Csupplier/supplier_ledger_report') ?>"><?php echo display('supplier_ledger') ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                    <?php } ?>
                    ...
                    <li class="treeview <?php if ($this->uri->segment('1') == ("Cmanufacturer")) { echo "active";}else{ echo " ";}?>">
                        <a href="#">
                            <i class="ti-truck"></i> <span><?php echo display('manufacturer') ?></span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <?php if($this->permission1->method('add_manufacturer','create')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('1') == ("Cmanufacturer") && $this->uri->segment('2') == ("")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cmanufacturer') ?>"><?php echo display('add_manufacturer') ?></a></li>
                            <?php } ?>
                            <?php if($this->permission1->method('manage_manufacturer','read')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('2') == ("manage_manufacturer")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cmanufacturer/manage_manufacturer') ?>"><?php echo display('manage_manufacturer') ?></a></li>
                            <?php } ?>
                            <?php if($this->permission1->method('manufacturer_ledger','read')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('2') == ("manufacturer_ledger_report") || $this->uri->segment('2') == ("manufacturer_ledger")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cmanufacturer/manufacturer_ledger_report') ?>"><?php echo display('manufacturer_ledger') ?></a></li>
                            <?php } ?>
                            <?php if($this->permission1->method('manufacturer_advance','create')->access()){ ?>
                                <li class="treeview <?php if ($this->uri->segment('2') == ("manufacturer_advance")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cmanufacturer/manufacturer_advance') ?>"><?php echo display('manufacturer_advance') ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                    <?php } ?>

                    <!-- Dropdown: Obat (Medicine/Product) -->
                    <?php
                    ...
                    <li class="treeview <?php if ($this->uri->segment('1') == "Cproduct" || $this->uri->segment('1') == ("Ccategory")) { echo "active";}else{ echo " ";}?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if($this->permission1->method('add_category','create')->access() || $this->permission1->method('add_category','read')->access() || $this->permission1->method('add_category','update')->access() || $this->permission1->method('add_category','delete')->access()) { ?>
                                <li class="treeview <?php if ($this->uri->segment('1') == ("Ccategory")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Ccategory')?>"><?php echo display('category') ?></a></li>
                            <?php } ?>
                            ...
                            if($this->permission1->method('medicine_type','create')->access() || $this->permission1->method('medicine_type','read')->access() || $this->permission1->method('medicine_type','update')->access() || $this->permission1->method('medicine_type','delete')->access()) { ?>
                                <li class="treeview <?php if ($this->uri->segment('2') == ("typeindex")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cproduct/typeindex')?>"><?php echo display('product_type') ?></a></li>
                            <?php } ?>
                            ...
                            <li class="treeview <?php if ($this->uri->segment('2') == ("unit_form") || $this->uri->segment('2') == ("unit_list")) { echo "active";}else{ echo " ";}?>">
                                ...
                                <ul class="treeview-menu">
                                    <li class="treeview <?php if ($this->uri->segment('1') == ("Cproduct") && $this->uri->segment('2') == ("unit_form")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cproduct/unit_form')?>"><?php echo display('add_unit') ?></a></li>
                                    <li class="treeview <?php if ($this->uri->segment('1') == ("Cproduct") && $this->uri->segment('2') == ("unit_list")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cproduct/unit_list')?>"><?php echo display('unit_list') ?></a></li>
                                </ul>
                            </li>
                            <?php } ?>
                            ...
                            if($this->permission1->method('add_medicine','create')->access()) { ?>
                                <li class="treeview <?php if ($this->uri->segment('1') == ("Cproduct") && $this->uri->segment('2') == ("")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cproduct')?>"><?php echo display('add_product') ?></a></li>
                            <?php } ?>

                            <!-- Import Medicine CSV -->
                            <?php
                            if($this->permission1->method('import_medicine_csv','create')->access()) { ?>
                                <li class="treeview <?php if ($this->uri->segment('2') == ("add_product_csv")) { echo "active";}else{ echo " ";}?>"><a href="<?php echo base_url('Cproduct/add_product_csv')?>"><?php echo display('import_product_csv') ?></a></li>
                            <?php } ?>
                    ...
                    <!-- Header Footer Struk -->
                    <?php
                    if($this->permission1->module('receipt_header_footer')->access()){ ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("Creceipt_setting")) { echo "active";}else{ echo " ";}?>">
                            <a href="<?php echo base_url('Creceipt_setting') ?>">
                                <i class="fa fa-file-text-o"></i> <span><?php echo display('receipt_header_footer') ?></span>
                            </a>
                        </li>
                    <?php } ?>

                    <!-- Ambang Notifikasi Kedaluwarsa -->
                    <?php
                    if($this->permission1->module('expiry_alert_setting')->access()){ ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("Cexpiry_setting")) { echo "active";}else{ echo " ";}?>">
                            <a href="<?php echo base_url('Cexpiry_setting') ?>">
                                <i class="pe-7s-clock"></i> <span><?php echo display('expiry_alert_setting') ?></span>
                            </a>
                        </li>
                    <?php } ?>
            ...
            <!-- Master Data menu end -->

            <!-- Product/Obat menu dipindahkan ke grup "Master Data" -->

            <!-- manufacturer/distributor menu dipindahkan ke grup "Master Data" -->


            <!-- Purchase menu dipindahkan ke dalam grup "Transaksi" (Invoice) -->
            <!-- Stok & Pengembalian dipindahkan ke dalam grup "Transaksi" (Invoice) -->
     ...
     <!-- ================= Fixed Assets start ====================== -->
      ...
      <!-- Personal loan end -->
        ...
        <?php } ?>
            ...
            <!-- supplier menu dipindahkan ke grup "Master Data" -->
