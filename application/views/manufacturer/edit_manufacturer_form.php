                ...
                <div class="panel panel-bd lobidrag">
                   ...
                   <?php echo form_open_multipart('Cmanufacturer/manufacturer_update',array( 'id' => 'manufacturer_update'))?>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="is_pbf" class="col-sm-4 col-form-label"><?php echo display('is_pbf') ?></label>
                            <div class="col-sm-8">
                                <select name="is_pbf" id="is_pbf" class="form-control" tabindex="5">
                                    <option value="0" {is_pbf_no_selected}><?php echo display('no') ?></option>
                                    <option value="1" {is_pbf_yes_selected}><?php echo display('yes') ?></option>
                                </select>
                            </div>
                        </div>
