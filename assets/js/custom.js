...
/*paid customer part*/
  ...
  /*manufacturer part*/
    ...
    var manufacturerTable = $('#manufacturerList').DataTable({
           ...
           // Default tampilkan 10 data per halaman
           'pageLength': 10,
...
var base_url = $('#base_url').val();
    ...
    $('#nearExpiry').DataTable({
           ...
           'pageLength': 25,
             dom:"'<'col-sm-4'l><'col-sm-4 text-center'><'col-sm-4'>Bfrtip", buttons:[
              { extend: "copy", className: "btn-sm prints" },
              { extend: "csv", title: "Near Expiry Medicine", className: "btn-sm prints" },
              { extend: "excel", title: "Near Expiry Medicine", className: "btn-sm prints" },
              { extend: "pdf", title: "Near Expiry Medicine", className: "btn-sm prints" },
              { extend: "print", className: "btn-sm prints" }
          ],
            'serverMethod': 'post',
            'ajax': {
               'url':base_url + 'Creport/CheckNearExpiryList',
               data:{
                csrf_test_name : CSRF_TOKEN,
               }
            },
